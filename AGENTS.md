...
- `pnpm typecheck` - Run type checking (generates Cloudflare and React Router types first)
- `pnpm deploy` - Build and deploy to Cloudflare Workers
- `pnpm preview` - Preview production build locally

## Architecture

This is a React Router v7 app deployed to Cloudflare Workers.
...
- `vite.config.ts` - Vite config with Cloudflare, Tailwind, and React Router plugins
